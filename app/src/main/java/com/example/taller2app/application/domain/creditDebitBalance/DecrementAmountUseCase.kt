...
class DecrementAmountUseCase @Inject constructor(private val creditDebitBalanceRepository: CreditDebitBalanceRepository) {
    suspend operator fun invoke(value: Int) = creditDebitBalanceRepository.decrementAmount(value)
}