...
class DeleteWorkDoneUseCase @Inject constructor(private val workDoneRepository: WorkDoneRepository) {
    suspend operator fun invoke(workDone:WorkDoneDataClass) = workDoneRepository.deleteWorkDone(workDone)
}